...
names(d) <- c( "authoryear",
              ...
              "interpretation",
              "use.rr.analysis", 
              "use.grams.analysis", # TODO(@mayamathur): Do we need this?
              "use.veg.analysis", # TODO(@mayamathur): Do we need this?
              "measure",
              "exposure",
              "headline",
              "bias",
...
# TODO: this is the IRR one that I didn't know how to do
#       See google doc for discussion
...
# What are we missing in the final data set? ###
missing <- anti_join(df.substance, d, by = "id")
missing
# Yong et al. 2009
# - should use
# Desmond et al. 2013
...
# Did we missing any reverse coding?
# If so, we would see them as yi>1 because of the log scale
posYi<- d %>% filter(yi>1)
posYi %>% count() > 0 

# Any zero values? we expect these from null effects
d %>% filter( yi == 0 )
